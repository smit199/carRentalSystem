<%-- 
    Document   : login
    Created on : 22 Apr, 2022, 4:48:00 PM
    Author     : smit sheth
--%>
      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <div class="p-3" style="text-align: center">
                <h2 class="text-red text-uppercase mb-md-3">Login</h2>
            </div>
            <c:if test="${not empty isValid && !isValid}">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              ...
              <p class="small fw-bold mt-2 pt-1 mb-0"><a href="index" class="link-danger">Back to home page !</a>
              </p>
            </div>
