<%-- 
    Document   : updatecar
    Created on : 25 Apr, 2022, 4:04:19 AM
    Author     : smit sheth
--%>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <div class="p-3" style="text-align: center">
                        <h2 class="text-red text-uppercase mb-md-3">Update Car Details</h2>
                    </div>
                    
                    <c:if test="${not empty isCarUpdated && !isCarUpdated}">
                        <div class="alert alert-danger mb-md-3">
                            unable to update car details, please try again!
                        </div>
                    </c:if>
                    
                    <c:if test="${not empty isCarUpdated && isCarUpdated}">
                        <div class="alert alert-success mb-md-3">
                            Car details are updated successfully!
                        </div>
                    </c:if>
                    ...
                    <form method='post' action="carupdate">
                        ...
                        <div class="form-outline mb-4 mt-4">
                            <input type="hidden" id="form3Example3" class="form-control form-control-md"
                                name="carid" value="${carById.getCarid()}" required/>
                        </div>
                        <div class="form-outline mb-4 mt-4">
                            ...
                            <input type="text" id="form3Example3" class="form-control form-control-md"
                                name="cname" value="${carById.getCname()}" required/>
                        </div>
                        ...
                        <select class="form-select mb-4 form-control form-control-md"
                            ...
                            <option value="${carById.getFueltype()}"><c:out value="${carById.getFueltype()}"/></option>
                        ...
                        <div class="form-outline mb-4 mt-4">
                            ...
                            <input type="text" id="form3Example3" class="form-control form-control-md"
                                name="cowner" value="${carById.getCowner()}" required/>
                        </div>
                        ...
                        <div class="form-outline mb-4 mt-4">
                            ...
                            <input type="tel" id="form3Example3" class="form-control form-control-md"
                                name="owner_mobile" value="${carById.getOwner_mobile()}" required
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="textarea" id="form3Example3" class="form-control form-control-md"
                                   value="${carById.getDescription()}" name="description" required/>
                        </div>
                        
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <input type="submit" value="Update Car" class="btn btn-primary btn-lg"
                                style="padding-left: 2.5rem; padding-right: 2.5rem;">
                            <!--<a class="btn btn-primary px-3" href="car">Cancel</a>-->
